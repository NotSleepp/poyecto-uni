    ...
    <div class="w-full flex flex-col items-center space-y-4 sm:items-end">
      ...
      >
        <div
          ...
          class="max-w-sm w-full bg-[#f8fafc] dark:bg-[#1c2533] shadow-lg rounded-lg pointer-events-auto ring-1 ring-[#475b7f]/10"
        >
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="ml-3 w-0 flex-1">
                <p class="text-sm font-medium text-[#2f3f57] dark:text-[#f8fafc]">
                  {{ currentNotification.title || getDefaultTitle }}
                </p>
                <p class="mt-1 text-sm text-[#57697f] dark:text-[#a4b4d1]">
              ...
              <div class="ml-4 flex-shrink-0 flex">
                <button
                  ...
                  class="bg-[#f8fafc] dark:bg-[#1c2533] rounded-md inline-flex text-[#57697f] hover:text-[#2f3f57] dark:text-[#a4b4d1] dark:hover:text-[#f8fafc] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#475b7f] dark:focus:ring-offset-[#1c2533]"
                >
            ...
            <div class="absolute bottom-0 left-0 right-0">
              <div 
                class="h-1 transition-all duration-300 rounded-b-lg"
